...
<!--
  <transition-group name="portFolioList" tag="div">
            <templates v-for="photo of portFolioPhotos" 
                 :key="photo.title" 
